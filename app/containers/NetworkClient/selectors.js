...
const makeSelectSigner = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("networkSigner")
  );
const makeSelectReader = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("networkReader")
  );
const makeSelectWriter = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("networkWriter")
  );
const makeSelectIdentity = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("networkIdentity")
  );
const makeSelectAccount = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("networkAccount")
  );
const makeSelectActiveNetwork = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("networkSelected")
  );
const makeSelectNetworks = () =>
  createSelector(selectClientState, (substate) => substate.get("networks"));
const makeSelectTokens = () =>
  createSelector(selectClientState, (substate) => substate.get("tokens"));
const makeSelectClaims = () =>
  createSelector(selectClientState, (substate) => substate.get("claims"));
const makeSelectTransaction = () =>
  createSelector(selectClientState, (substate) => substate.get("transaction"));
const makeSelectOffline = () =>
  createSelector(selectClientState, (substate) => substate.get("offlineMode"));
const makeSelectSwitchTime = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("networkSwitchTime")
  );
const makeSelectRex = () =>
  createSelector(selectClientState, (substate) => substate.get("rex"));
/**
 * loading selectors
 */

const makeSelectReaderLoading = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("readerLoading")
  );
const makeSelectWriterLoading = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("writerLoading")
  );
const makeSelectAccountLoading = () =>
  createSelector(selectClientState, (substate) =>
    substate.get("accountLoading")
  );
const makeSelectTokenList = () =>
  createSelector(selectClientState, (substate) => substate.get("tokenList"));
/**
 * Enabled selectors
 */
